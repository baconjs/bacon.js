(function() {
  var Bacon, Dispatcher, End, Event, EventStream, Initial, Next, Property, assert, assertEvent, assertFunction, cloneArray, empty, end, head, initial, next, nop, remove, tail, _ref,
  ...
  Property = (function() {
    ...
    Property.prototype.onValue = function(f) {
      return this.subscribe(function(event) {
        if (!event.isEnd()) return f(event.value);
      });
    };
