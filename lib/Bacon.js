(function() {
  var Bacon, Bus, Dispatcher, End, Event, EventStream, Initial, Next, Observable, Property, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, empty, end, former, head, initial, latter, next, nop, remove, tail, takeUntilSubscribe, _ref,
    _this = this,
