(function() {
  var Bacon, Bus, Dispatcher, End, Error, Event, EventStream, Initial, Next, Observable, Property, PropertyDispatcher, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, contains, empty, end, filter, former, head, initial, isEvent, latter, map, next, nop, remove, tail, toEvent, _ref,
    _this = this,
  ...
  Event = (function() {
    ...
    Event.prototype.done = function() {
      var listener, waiters, _i, _len, _results;
    ...
    Event.prototype.onDone = function(listener) {
      if ((this.waiters != null) && !contains(this.waiters, listener)) {
        return this.waiters.push(listener);
      } else {
        return this.waiters = [listener];
      }
    };
  ...
  Initial = (function(_super) {
    ...
    Initial.prototype.onDone = function(listener) {
      return listener();
    };
