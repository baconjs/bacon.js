(function() {
  var Bacon, Bus, Dispatcher, End, Event, EventStream, Initial, Next, Observable, Property, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, empty, end, former, head, initial, latter, next, nop, remove, tail, takeUntilSub, _ref,
    _this = this,
  ...
  EventStream = (function(_super) {
    ...
    EventStream.prototype.takeUntil = function(stopper) {
      return new EventStream(takeUntilSub(this, stopper));
    };
  ...
  Property = (function(_super) {
    ...
    Property.prototype.takeUntil = function(stopper) {
      return new Property(takeUntilSub(this, stopper));
    };
  ...
  takeUntilSub = function(src, stopper) {
