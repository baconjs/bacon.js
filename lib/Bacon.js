(function() {
  var Bacon, Bus, Dispatcher, End, Error, Event, EventStream, Initial, Next, None, Observable, Property, PropertyDispatcher, Some, always, assert, assertArray, assertEvent, assertFunction, assertString, cloneArray, cloneObject, contains, empty, end, filter, former, head, initial, isEvent, isFieldKey, isFunction, just, latter, makeFunction, map, methodCall, next, nop, partiallyApplied, remove, tail, toCombinator, toEvent, toFieldExtractor, toFieldKey, toOption, toSimpleExtractor, _ref,
    _this = this,
