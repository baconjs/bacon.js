(function() {
  var Bacon, Bus, Dispatcher, End, Error, Event, EventStream, Initial, Next, Observable, Property, PropertyDispatcher, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, contains, empty, end, filter, former, head, initial, isEvent, isFunction, latter, map, next, nop, remove, tail, toEvent, _ref,
    _this = this,
  ...
  Observable = (function() {
    ...
    Observable.prototype.map = function(f) {
      if (isFunction(f)) {
        ...
        return this.withHandler(function(event) {
          return this.push(event.apply(f));
        });
      }
    };
