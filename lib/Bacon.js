(function() {
  var Bacon, Dispatcher, End, Event, EventStream, Initial, Next, Property, assert, assertEvent, empty, end, head, initial, next, remove, tail, _ref;
