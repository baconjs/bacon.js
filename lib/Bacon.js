(function() {
  var Bacon, Bus, Dispatcher, End, Error, Event, EventStream, Initial, Next, Observable, Property, PropertyDispatcher, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, empty, end, filter, former, head, initial, isEvent, latter, map, next, nop, remove, tail, toEvent, _ref,
    _this = this,
  ...
  Observable = (function() {
    ...
    Observable.prototype.takeUntil = function(stopper) {
      ...
      return this.withSubscribe(function(sink) {
        ...
        if (!unsubscribed) unsubSrc = src.subscribe(srcSink);
        return unsubBoth;
      });
    };
