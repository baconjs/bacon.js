(function() {
  var Bacon, Bus, Dispatcher, End, Error, Event, EventStream, Initial, Next, Observable, Property, assert, assertArray, assertEvent, assertFunction, cloneArray, cloneObject, empty, end, filter, former, head, initial, isEvent, latter, map, next, nop, remove, tail, takeUntilSubscribe, toEvent, _ref,
    _this = this,
  ...
  EventStream = (function(_super) {
    ...
    EventStream.prototype.takeUntil = function(stopper) {
      return new EventStream(takeUntilSubscribe(this, stopper));
    };
  ...
  Property = (function(_super) {
    ...
    function Property(subscribe) {
      ...
      this.takeUntil = __bind(this.takeUntil, this);
      this.distinctUntilChanged = __bind(this.distinctUntilChanged, this);
    ...
    Property.prototype.filter = function(f) {
      var previousMathing,
        _this = this;
      previousMathing = void 0;
      return new Property(function(sink) {
        return _this.subscribe(function(event) {
          if (event.filter(f)) {
            sink(event);
            if (event.hasValue()) return previousMathing = event.value;
          } else if (event.isInitial() && (previousMathing != null)) {
            return sink(initial(previousMathing));
          } else {
            return Bacon.more;
          }
        });
    ...
    Property.prototype.distinctUntilChanged = function() {
      var _this = this;
      return new Property(function(sink) {
        var previous;
        previous = void 0;
    ...
    Property.prototype.takeUntil = function(stopper) {
      return new Property(takeUntilSubscribe(this, stopper));
    };
  ...
  takeUntilSubscribe = function(src, stopper) {
