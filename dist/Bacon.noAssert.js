(function (global, factory) {
    ...
    Bacon.combineAsArray = function () {
        ...
        if (streams.length) {
            ...
            return withDesc(new Desc(Bacon, 'combineAsArray', streams), when(sources, function () {
    ...
    function flatMap_(root, f, firstOnly, limit) {
        var rootDep = [root];
        var childDeps = [];
    ...
    Observable.prototype.flatMapWithConcurrencyLimit = function (limit) {
        ...
        var desc = new Desc(this, 'flatMapWithConcurrencyLimit', [limit].concat(args));
    ...
    EventStream.prototype.takeUntil = function (stopper) {
        var endMarker = {};
        return withDesc(new Desc(this, 'takeUntil', [stopper]), groupSimultaneous(this.mapEnd(endMarker), stopper.skipErrors()).withHandler(function (event) {
            if (!event.hasValue()) {
                return this.push(event);
            } else {
    ...
    function scan(seed, f) {
        ...
        resultProperty = new Property(new Desc(this, 'scan', [
            seed,
            f
        ]), subscribe);
    ...
    Observable.prototype.groupBy = function (keyF) {
        var limitF = arguments.length <= 1 || arguments[1] === undefined ? _.id : arguments[1];
        var streams = {};
        var src = this;
    ...
    EventStream.prototype.throttle = function (delay) {
        return withDesc(new Desc(this, 'throttle', [delay]), this.bufferWithTime(delay).map(function (values) {
